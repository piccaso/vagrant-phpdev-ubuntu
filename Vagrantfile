...
Vagrant.configure("2") do |config|
  ...
  config.vm.network :forwarded_port, guest: 3306, host: 3367
  ...
  config.vm.synced_folder "share", "/share", :create => true, :extra => 'dmode=777,fmode=666'
